...
You can place `https://api.tronmc.com/amend/versions/(SERVER TYPE HERE)/1.21.4/download/` into the executable URL and click **`Update Executable`** to download the latest version of the server jar.
